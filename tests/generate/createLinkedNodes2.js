...
const propC = new PropertyNode({ label: 'c', range: rangeTypes.linkedClass('https://www.schesign.com/u/csenn/test_linking_1/master/class/class2') })
...
class3.addProperty('https://www.schesign.com/u/csenn/test_linking_1/master/property/a')
class3.addProperty(propC)
class3.addProperty(propD)

class4.addProperty('https://www.schesign.com/u/csenn/test_linking_1/master/property/a')
