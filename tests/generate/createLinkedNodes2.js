...
const propC = new PropertyNode({ label: 'c', range: rangeTypes.linkedClass('https://www.schesign.com/o/tests/linked_nodes_1/0.1.0/class/class2') });
...
class3.addProperty('https://www.schesign.com/o/tests/linked_nodes_1/0.1.0/property/a');
class3.addProperty(propC);
class3.addProperty(propD);

class4.addProperty('https://www.schesign.com/o/tests/linked_nodes_1/0.1.0/property/a');
